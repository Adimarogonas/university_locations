...
void main() {
  final UniversityLocationsPlatform initialPlatform =
  ...
  test('getPlatformVersion', () async {
    ...
    MockUniversityLocationsPlatform fakePlatform =
        MockUniversityLocationsPlatform();
  ...
  test('getNearestUniversity', () {
    expect(UniversityLocations().findNearestUniversity(33.6405, -117.8443),
